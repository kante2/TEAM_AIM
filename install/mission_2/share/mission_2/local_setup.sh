...
: ${AMENT_CURRENT_PREFIX:="/root/TEAM_AIM/install/mission_2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mission_2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mission_2/environment/path.sh"
