...
: ${AMENT_CURRENT_PREFIX:="/root/TEAM_AIM/install/mission_3"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mission_3/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mission_3/environment/path.sh"
